...
image::images/klara.png[alt="Persona Klar Schwitzer Team",width=300,align=left]
...
image::images/tim.png[alt="Persona Tim Fun Team",width=300,align=left]
...
image::images/timVerhaltensvariablen.png[alt="Verhaltensvariablen Tim Grafik" ,width=400]