...
Franz Starke <s86320@htw-dresden.de>
{localdatetime}
...
- Informationsübertragung mit einem Datenspeicher.
...
. Standardisierten Syntax verwenden
...
image::images/c4_system_context.png[]
image::images/c4_container.png[]
