<script setup>
	...
	const homeState = ref('dashboard');
	provide('homeState', homeState);
    const tournamentName = "Nikolaus Turnier 2024"
    ...
    function changeState(state) {
        ...
        if (dashboard && games && teams && settings) {
            dashboard.classList.remove("gradient");
            games.classList.remove("gradient");
            teams.classList.remove("gradient");
            settings.classList.remove("gradient");

            const activeElement = document.getElementById(state);
            if (activeElement) {
                activeElement.classList.add("gradient");
            }
        }
    }
...
<template>
    ...
    <div id="content">
        <Dashboard v-if="homeState === 'dashboard'"/>
        <Games v-if="homeState === 'games'"/>
    </div>

    <div id="navbar">
        <div id="bar">
            <div id="dashboard" @click="changeState('dashboard')">
            ...
            <div id="games" @click="changeState('games')">
            ...
            <div id="teams" @click="changeState('teams')">
            ...
            <div id="settings" @click="changeState('settings')">
...
<style scoped>
    ...
    #dashboard, #games, #teams, #settings {
        padding: 10px;
        border-radius: 30px;
        font-weight: 600;
        stroke-width: 5%;
