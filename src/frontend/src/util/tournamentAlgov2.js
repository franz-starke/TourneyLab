...
// --------------------------------------------------------------
// Generiert gewichtete Spielepaarungen
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Enforce Team Gap für festen Rundenrhythmus
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Enforce Team Gap mit flexibler Lücke
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Verteile alle Spiele einer Gruppe auf Felder und ordne Schiris zu
// --------------------------------------------------------------
function distributeGamesToFieldsWithOneGroup(onlyTeamMatches, numFields, boolRueckspiel) {
    ...
    if (numFields === 1) {
        ...
        while (onlyMatchesWithRef.length) {
            if (onlyMatchesWithRef.length > 0) fields[1].push(onlyMatchesWithRef.pop());
            if (onlyMatchesWithRef.length > 0) fields[2].push(onlyMatchesWithRef.pop());
        }
...
// --------------------------------------------------------------
// Für beide Gruppen: Felder füllen (2, 3 oder 4 Felder)
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Verteile Spiele & Schiedsrichter für beide Gruppen (für Export)
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Konflikte im Spielplan erkennen
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Hauptprogramm (zum Testen, wird nicht exportiert)
// --------------------------------------------------------------
...
// --------------------------------------------------------------
// Export: Turnier-Algorithmus für externe Verwendung
// --------------------------------------------------------------
