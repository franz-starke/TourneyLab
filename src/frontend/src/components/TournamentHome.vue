...
<template>
	<div class="flex flex-col h-[100svh] overflow-hidden">
		<header
			class="sticky top-0 pt-[env(safe-area-inset-top)] px-4 pb-2 mt-4 mb-2"
		>
			<h1
				class="flex w-full h-12 justify-center items-center rounded-full text-2xl font-bold bg-[var(--color-element)]"
				ref="tournamentName"
			>
		...
		>
			<div
				class="flex w-full h-18 justify-between items-center rounded-3xl bg-[var(--color-element)]"
			>
