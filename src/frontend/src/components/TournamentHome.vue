...
<template>
	<div class="flex flex-col h-[100svh] overflow-hidden lg:items-center">
		<header class="sticky top-0 pt-[env(safe-area-inset-top)] px-4 pb-2 mt-4 mb-2 lg:w-150">
		...
		<nav class="sticky bottom-0 px-4 pt-2 pb-[calc(env(safe-area-inset-bottom)+1rem)] mt-2 lg:w-150">
